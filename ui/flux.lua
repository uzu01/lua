...
if game.CoreGui:FindFirstChild("MobTog") then
    game.CoreGui:FindFirstChild("MobTog"):Destroy()
end
...
function Flux:Window(text, bottom, mainclr)
    ...
    if UserInputService.TouchEnabled and UserInputService.KeyboardEnabled == false then
        local MobTog = Instance.new("ScreenGui")
        local ImageButton = Instance.new("ImageButton")
        local UICorner = Instance.new("UICorner")

        MobTog.Parent = game.CoreGui
        MobTog.Name = "MobTog"
    ...
    function Tabs:Tab(text, ico)
        ...
        TabIcon.Image = "rbxthumb://type=Asset&id=" .. tostring(ico) .. "&w=420&h=420"
